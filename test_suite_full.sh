...
cmake -B "$BUILD_DIRECTORY" -S . -DBUILD_TESTING=OFF -DNovapp_SETUP=advection_gap -DNovapp_NDIM=1 -DNovapp_EOS=PerfectGas -DNovapp_GRAVITY=Uniform -DNovapp_GEOM=Cartesian -DKokkos_ENABLE_DEPRECATED_CODE_4=OFF
