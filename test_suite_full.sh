...
cmake -DBUILD_TESTING=OFF -DNovapp_SETUP=shock_tube -DNovapp_NDIM=1 -DNovapp_EOS=PerfectGas -DNovapp_GRAVITY=Uniform -DNovapp_GEOM=Spherical -DKokkos_ENABLE_DEPRECATED_CODE_4= -S . -B "$BUILD_DIRECTORY"
cmake --build "$BUILD_DIRECTORY"
...
cmake -DBUILD_TESTING=OFF -DNovapp_SETUP=shock_tube -DNovapp_NDIM=2 -DNovapp_EOS=PerfectGas -DNovapp_GRAVITY=Uniform -DNovapp_GEOM=Spherical -DKokkos_ENABLE_DEPRECATED_CODE_4= -S . -B "$BUILD_DIRECTORY"
cmake --build "$BUILD_DIRECTORY"
...
cmake -DBUILD_TESTING=OFF -DNovapp_SETUP=sedov2d -DNovapp_NDIM=2 -DNovapp_EOS=PerfectGas -DNovapp_GRAVITY=Uniform -DNovapp_GEOM=Spherical -DKokkos_ENABLE_DEPRECATED_CODE_4= -S . -B "$BUILD_DIRECTORY"
cmake --build "$BUILD_DIRECTORY"
