                    ...
                    for (int idim = 0; idim < ndim; ++idim) {
                        ...
                        if (geom == Geometry::Geom_spherical) {
                            ...
                            if (idim == 0) {
                                ...
                                rhou_new(i, j, k, idim) += source_grad_pres(dtodv, primL.P, primR.P, ds(i, j, k, idim), ds(i_p, j_p, k_p, idim));

                                if (ndim == 2 || ndim == 3) {
                                    // Velocity term (e_{r}): rho * u_{th} * u_{th} / r
                                    rhou_new(i, j, k, idim) += source_grad_u_r(
                                            dtodv,
                                            primL.rho,
                                            primR.rho,
                                            primL.u[1],
                                    ...
                                    rhou_new(i, j, k, 1) -= source_grad_u_idir_r(
                                            dtodv,
                                            x0(i),
                                            x0(i + 1),
                                            primL.rho,
                                ...
                                if (ndim == 3) {
                                    ...
                                    rhou_new(i, j, k, 2) -= source_grad_u_idir_r(
                                            dtodv,
                                            x0(i),
                                            x0(i + 1),
                                            primL.rho,
                            ...
                            if (idim == 1) {
                                ...
                                if (ndim == 3) {
                                    ...
                                    rhou_new(i, j, k, idim) += source_grad_u_th(
                                            dtodv,
                                            x1(j),
                                            x1(j + 1),
                                            primL.rho,
                                    ...
                                    rhou_new(i, j, k, 2) -= source_grad_u_phi(
                                            dtodv,
                                            x1(j),
                                            x1(j + 1),
                                            primL.rho,
