...
public:
    ...
    virtual void execute(
            ...
            KV_double_6d const& fx_rec) const = 0;
};
...
public:
    explicit HancockExtrapolationReconstruction(EoS const& eos) : m_eos(eos) {}
                        ...
                        if (geom == Geometry::Geom_spherical) {
                            for (int ipos = 0; ipos < ndim; ++ipos) {
                                if (idim == 0) {
                                    ...
                                    rhou_rec(i, j, k, 0, ipos, idim)
                                            += source_grad_pres(dtodv, primL.P, primR.P, ds(i, j, k, idim), ds(i_p, j_p, k_p, idim));
                                    rhou_rec(i, j, k, 1, ipos, idim)
                                            += source_grad_pres(dtodv, primL.P, primR.P, ds(i, j, k, idim), ds(i_p, j_p, k_p, idim));

                                    if (ndim == 2 || ndim == 3) {
                                        // Velocity term (e_{r}): rho * u_{th} * u_{th} / r
                                        rhou_rec(i, j, k, 0, ipos, idim) += source_grad_u_r(
                                                dtodv,
                                                primL.rho,
                                                primR.rho,
                                                primL.u[1],
                                                ...
                                                ds(i, j, k, idim),
                                                ds(i_p, j_p, k_p, idim));
                                        rhou_rec(i, j, k, 1, ipos, idim) += source_grad_u_r(
                                                dtodv,
                                                primL.rho,
                                                primR.rho,
                                                primL.u[1],
                                        ...
                                        rhou_rec(i, j, k, 0, ipos, 1) -= source_grad_u_idir_r(
                                                dtodv,
                                                x0(i),
                                                x0(i + 1),
                                                primL.rho,
                                                ...
                                                ds(i, j, k, idim),
                                                ds(i_p, j_p, k_p, idim));
                                        rhou_rec(i, j, k, 1, ipos, 1) -= source_grad_u_idir_r(
                                                dtodv,
                                                x0(i),
                                                x0(i + 1),
                                                primL.rho,
                                    ...
                                    if (ndim == 3) {
                                        ...
                                        rhou_rec(i, j, k, 0, ipos, 2) -= source_grad_u_idir_r(
                                                dtodv,
                                                x0(i),
                                                x0(i + 1),
                                                primL.rho,
                                                ...
                                                ds(i, j, k, idim),
                                                ds(i_p, j_p, k_p, idim));
                                        rhou_rec(i, j, k, 1, ipos, 2) -= source_grad_u_idir_r(
                                                dtodv,
                                                x0(i),
                                                x0(i + 1),
                                                primL.rho,
                                ...
                                if (idim == 1) {
                                    ...
                                    if (ndim == 3) {
                                        ...
                                        rhou_rec(i, j, k, 0, ipos, idim) += source_grad_u_th(
                                                dtodv,
                                                x1(j),
                                                x1(j + 1),
                                                primL.rho,
                                                ...
                                                ds(i, j, k, idim),
                                                ds(i_p, j_p, k_p, idim));
                                        rhou_rec(i, j, k, 1, ipos, idim) += source_grad_u_th(
                                                dtodv,
                                                x1(j),
                                                x1(j + 1),
                                                primL.rho,
                                        ...
                                        rhou_rec(i, j, k, 0, ipos, 2) -= source_grad_u_phi(
                                                dtodv,
                                                x1(j),
                                                x1(j + 1),
                                                primL.rho,
                                                ...
                                                ds(i, j, k, idim),
                                                ds(i_p, j_p, k_p, idim));
                                        rhou_rec(i, j, k, 1, ipos, 2) -= source_grad_u_phi(
                                                dtodv,
                                                x1(j),
                                                x1(j + 1),
                                                primL.rho,
