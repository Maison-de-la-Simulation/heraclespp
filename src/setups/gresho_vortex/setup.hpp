...
public:
    ...
    explicit ParamSetup(INIReader const& reader) : rho0(reader.GetReal("Initialisation", "rho0", 1.0)), u0(reader.GetReal("Initialisation", "u0", 1.0)), Ma(reader.GetReal("Initialisation", "Ma", 1.0)) {}
};
