        ...
        KV_double_4d const& fx) const final
    {
        ...
        if (ndim == 3)
        {
            ...
            Kokkos::parallel_for(
                ...
                double rad_clump = 4E10;

                // 10 clumps until 3.85e11 m
                Kokkos::Array<double, 10> r_pos_clump = {216305518571.13452, 348195276711.497,
                    161553985718.6756, 192362520487.9005, 206306752836.7985, 360717718651.7831,
                    283931013109.5073, 324421778626.6851, 140156993303.56674, 380526423342.9094};

                Kokkos::Array<double, 10> th_pos_clump = {1.7307084011814908, 1.0641893184701132,
                    1.6906050864556894, 1.1882783998614337, 1.5918083385601176, 1.4196136265563704,
                    1.938235284586551, 1.3955813568014275, 1.1481739629615901, 1.8422941549618643};

                Kokkos::Array<double, 10> phi_pos_clump = {1.8365766632529903, 1.0166815436318757,
                    1.9160012703753164, 1.5073400767520915, 1.5850777684590471, 1.7866085780330274,
                    1.2354285498523598, 1.1844984755996388, 1.5651341041047897, 1.5091308454902825};

                double rad_clump = 3.5E10; */

                // 20 clumps until 4e11 m, 13 between the two shocks
                Kokkos::Array<double, 20> r_pos_clump = {213576237296.75058, 217102292950.12146,
                    203504810682.90854, 173786626363.11472, 306728400635.66016, 225047122456.7254,
                    218696380577.82828, 391834389534.13794, 352883483951.2461, 394188838553.0441,
                    398108985314.6975, 380865891676.1769, 391443954091.90063, 397781284455.46796,
                    368549273014.9381, 363460843175.3237, 384436293869.0261, 378856595657.3654,
                    370014604335.69794, 354211342726.9502};

                Kokkos::Array<double, 20> th_pos_clump = {1.2344322932968295, 1.951440918034054,
                    1.4415545905264857, 1.8192822964184772, 1.9436569349148138, 1.1639866255443305,
                    1.8355547515425772, 1.0923968692838741, 1.4348842447321113, 1.4737387440261442,
                    1.210162680252361, 1.899388499930097, 1.6371071396719852, 1.304859349646808,
                    1.3049996709999494, 1.8547772296582148, 1.9656423740732207, 1.2382085639074218,
                    1.4376487573943169, 1.2355720951505282};

                Kokkos::Array<double, 20> phi_pos_clump = {1.0861946757042251, 1.1096940426247088,
                    1.2245670557770834, 1.8306363863980182, 1.9184724911647248, 1.2907574300347822,
                    1.3580555789436464, 1.8318547586316365, 1.6571989349123322, 1.46696054242519,
                    1.5812984545376345, 1.9358885690576533, 1.8858451111121104, 1.6873596513675069,
                    1.3682927253758765, 1.973464113546067, 1.6081898102003422, 1.163776364592176,
                    1.7943163742830635, 1.7931668616138858};

                //double rad_clump = 3.5E10;
                Kokkos::Array<double, 20> rad_clump = {1.8350445918791123, 3.0021435839302844,
                    2.268808771172135, 2.946116899764045, 1.850058305383049, 1.5145054828751485,
                    2.0861328800640893, 1.5679171609933997, 2.901417311673084, 1.8183126972542083,
                    1.6201058704159872, 1.9128149206211398, 2.0834653576001223, 2.0245893094604788,
                    3.1467583738351497, 1.607704863190555, 2.0276531717241637, 2.9027219453299624,
                    2.053457989438423, 1.7128048563661902};
