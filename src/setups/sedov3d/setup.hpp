...
public:
    ...
    explicit ParamSetup(INIReader const& reader) : rho0(reader.GetReal("Initialisation", "rho0", 1.0)), P0(reader.GetReal("Initialisation", "P0", 1.0)), E1(reader.GetReal("Initialisation", "E1", 1.0)), ny(reader.GetReal("Grid", "Ny_glob", 1.0)), nz(reader.GetReal("Grid", "Nz_glob", 1.0)) {}
};
