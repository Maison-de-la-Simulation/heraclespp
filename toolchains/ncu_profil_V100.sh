...
ncu --nvtx --import-source yes --target-processes all --launch-skip 0 --set full --kernel-name-base demangled -k regex:".*LinearReconstruction" -f -o report.ncu-rep ./../build_V100/src/nova++ ./../inputs/rayleigh_taylor3d.ini
