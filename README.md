...
\note For more complex compilation scenarios, please refer to the `toolchains` directory or the [Kokkos documentation](https://kokkos.org/kokkos-core-wiki/get-started.html).
...
\warning Be sure to source the script that matches your shell (e.g., .env.bash for bash, .env.zsh for zsh).
